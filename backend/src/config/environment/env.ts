...
declare var connectionOptions: ConnectionOptions;
let databaseTypes: typeof connectionOptions.type;

const DATABASE_NAME: string = process.env.DATABASE_NAME!;
const DATABASE_TYPE: typeof databaseTypes = process.env.DATABASE_TYPE as typeof databaseTypes;
